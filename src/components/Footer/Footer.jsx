...
const Footer = () => {
  return (
    <footer className="text-black p-10 bg-[#e5e7eb] mt-10">
      <div className="text-center mb-16">
        <div className="flex justify-center gap-4">
          ...
          >
            <linearGradient
              id="R_FDZw81mQ~I9YaM19jQpa_Wm9BpxflIpY0_gr1"
              x1="23.45"
              x2="23.45"
              y1="13.887"
              y2="57"
            ...
            <polygon
              fill="url(#R_FDZw81mQ~I9YaM19jQpa_Wm9BpxflIpY0_gr1)"
              points="7,35.316 23.547,57 39.9,57 7,13.887"
            ></polygon>
            <linearGradient
              id="R_FDZw81mQ~I9YaM19jQpb_Wm9BpxflIpY0_gr2"
              x1="46.721"
              x2="46.721"
              y1="15.06"
              y2="42"
            ...
            <polygon
              fill="url(#R_FDZw81mQ~I9YaM19jQpb_Wm9BpxflIpY0_gr2)"
              points="52.795,42 57,36.489 57,15.06 36.442,42"
            ></polygon>
            <linearGradient
              id="R_FDZw81mQ~I9YaM19jQpc_Wm9BpxflIpY0_gr3"
              x1="32"
              x2="32"
              y1="12.887"
              y2="58"
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 mx-auto text-center items-start">
        <nav className="grid grid-cols-1 md:mb-0 mb-4">
          ...
          <div className=" flex items-center mx-auto gap-3">
            <a
              href="https://www.facebook.com/joyeta.mondal23?mibextid=ZbWKwL"
              className="link link-hover text-[#09080F99]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
            ...
            <a
              href="https://www.linkedin.com/in/joyeta-mondal-kotha-b1854623b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              className="link link-hover text-[#09080F99]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
